...
const PrenatalHistoryDetails = ({ selectedRow, myProfile, activeTab, handleCloseHistoryDetails }) => {
  return (
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="p-2 border rounded">{myProfile?.lastname || '-'}</p>
              </div>
              <div>
                <label className="block mb-2">FIRSTNAME</label>
                <p className="p-2 border rounded">{myProfile?.firstname || '-'}</p>
              </div>
              <div>
                <label className="block mb-2">MIDDLE INITIAL</label>
                <p className="p-2 border rounded">{myProfile?.middleInitial || '-'}</p>
              </div>
            </div>
          </div>
